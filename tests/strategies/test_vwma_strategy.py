"""Companion tests for VWMAStrategy — RegimeBiasMixin integration."""
from unittest.mock import MagicMock

import pytest
from src.strategies.base_strategy import Signal, SignalType
from src.strategies.vwma_strategy import VWMAStrategy


def _make_strategy(regime_hint: str) -> VWMAStrategy:
    s = VWMAStrategy.__new__(VWMAStrategy)
    s.config = MagicMock()
...
def test_has_regime_bias_mixin():
    ...
    assert issubclass(VWMAStrategy, RegimeBiasMixin)
